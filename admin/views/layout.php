...
<meta name="upload-url" content="<?= e(url('admin/editor-upload')) ?>">
...
<script src="<?= e(asset('admin/assets/vendor/ckeditor.js')) ?>"></script>
<script src="<?= e(asset('admin/assets/admin-editor.js')) ?>"></script>
</body>
</html>
